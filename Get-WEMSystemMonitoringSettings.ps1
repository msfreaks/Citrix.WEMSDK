<#
    .Synopsis
    Returns a WEM System Monitoring Settings object from the WEM Database.
    ...
    Version: 0.9.0
#>
function Get-WEMSystemMonitoringSettings {
    [CmdletBinding()]
    param(
    ...
    process {
        ...
        $SQLQuery = "SELECT * FROM VUEMSystemMonitoringSettings WHERE IdSite = $($IdSite) ORDER BY IdItem"
