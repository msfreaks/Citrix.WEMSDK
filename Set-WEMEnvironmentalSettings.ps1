...
function Set-WEMEnvironmentalSettings {
    ...
    process {
        ...
        foreach($key in $keys) {
            ...
            $SQLQuery = "UPDATE VUEMEnvironmentalSettings SET Value = '"
            ...
            New-ChangesLogEntry -Connection $Connection -IdSite $IdSite -IdElement $IdObject -ChangeType "Update" -ObjectName $key -ObjectType "Policies and Profiles\Environmental Settings" -NewValue $sqlValue -ChangeDescription $null -Reserved01 $null 
        }
    }
}
