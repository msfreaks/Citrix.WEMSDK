<#
    .Synopsis
    Returns a WEM Environmental Settings object from the WEM Database.
    ...
    Version: 0.9.0
#>
function Get-WEMEnvironmentalSettings {
    [CmdletBinding()]
    param(
    ...
    process {
        ...
        $SQLQuery = "SELECT * FROM VUEMEnvironmentalSettings WHERE IdSite = $($IdSite) ORDER BY IdItem"
