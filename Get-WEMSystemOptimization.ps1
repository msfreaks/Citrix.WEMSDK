<#
    .Synopsis
    Returns a WEM System Optimization object from the WEM Database.
    ...
    Version: 0.9.0
#>
function Get-WEMSystemOptimization {
    [CmdletBinding()]
    param(
    ...
    process {
        ...
        $SQLQuery = "SELECT * FROM VUEMSystemUtilities WHERE IdSite = $($IdSite) ORDER BY IdItem"
