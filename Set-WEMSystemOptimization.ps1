...
function Set-WEMSystemOptimization {
    ...
    process {
        ...
        foreach($key in $keys) {
            ...
            $SQLQuery = "UPDATE VUEMSystemUtilities SET Value = '"
            ...
            New-ChangesLogEntry -Connection $Connection -IdSite $IdSite -IdElement $IdObject -ChangeType "Update" -ObjectName $key -ObjectType "System Utilities\Setting" -NewValue $sqlValue -ChangeDescription $null -Reserved01 $null 
        }
    }
}
