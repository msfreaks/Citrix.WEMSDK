<#
    .Synopsis
    Returns a WEM UPM Settings object from the WEM Database.
...
function Get-WEMUPMSettings {
    ...
    process {
        ...
        $SQLQuery = "SELECT * FROM VUEMUPMSettings WHERE IdSite = $($IdSite) ORDER BY IdItem"
