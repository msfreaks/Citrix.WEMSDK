...
function Set-WEMUSVSettings {
    ...
    process {
        ...
        foreach($key in $keys) {
            ...
            $SQLQuery = "UPDATE VUEMUSVSettings SET Value = '"
            ...
            New-ChangesLogEntry -Connection $Connection -IdSite $IdSite -IdElement $IdObject -ChangeType "Update" -ObjectName $key -ObjectType "Policies and Profiles\Microsoft USV Settings" -NewValue $sqlValue -ChangeDescription $null -Reserved01 $null 
        }
    }
}
