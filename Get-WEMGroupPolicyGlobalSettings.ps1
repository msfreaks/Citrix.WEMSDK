<#
    .Synopsis
    Returns a WEM GroupPolicy Global Settings object from the WEM Database.
    ...
    Version: 0.9.0
#>
function Get-WEMGroupPolicyGlobalSettings {
    [CmdletBinding()]
    param(
    ...
    process {
        ...
        $SQLQuery = "SELECT * FROM GroupPolicyGlobalSettings WHERE IdSite = $($IdSite) ORDER BY IdSetting"
