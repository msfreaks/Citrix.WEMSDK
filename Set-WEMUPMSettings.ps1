...
function Set-WEMUPMSettings {
    ...
    process {
        ...
        foreach($key in $keys) {
            ...
            $SQLQuery = "UPDATE VUEMUPMSettings SET Value = '"
            ...
            New-ChangesLogEntry -Connection $Connection -IdSite $IdSite -IdElement $IdObject -ChangeType "Update" -ObjectName $key -ObjectType "Policies and Profiles\Citrix UPM Settings" -NewValue $sqlValue -ChangeDescription $null -Reserved01 $null 
        }
    }
}
